    ...
    <div className="min-h-screen bg-[#030303] text-white font-sans overflow-x-hidden selection:bg-cyan-500 selection:text-black">
      ...
      <section id="contact" className="py-20 md:py-32 text-center px-6">
        ...
        <div className="flex gap-6 justify-center mt-12 md:mt-16">
           {/* Instagram */}
           <a href="https://instagram.com/amdwildanabdillah" target="_blank" rel="noreferrer" className="group p-3 rounded-full border border-white/10 hover:border-cyan-400 hover:bg-cyan-400/10 transition duration-300">
           ...
           {/* LinkedIn */}
           <a href="https://linkedin.com/in/wildanabdillah" target="_blank" rel="noreferrer" className="group p-3 rounded-full border border-white/10 hover:border-cyan-400 hover:bg-cyan-400/10 transition duration-300">
           ...
           <a href="#" className="group p-3 rounded-full border border-white/10 hover:border-cyan-400 hover:bg-cyan-400/10 transition duration-300">
